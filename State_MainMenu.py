...
class State_MainMenu(BaseState):
    ...
    def __drawUIs(self):
        if self.page == 0:
            self.AddDrawSprite("Title", Vector2(32, -50), scale=Vector2(1,1))
            ...
            self.AddDrawUIFont("UP/DOWN Key : Navigation", Vector2(32, 420), MYCOLOR.RED, 30)

        elif self.page == 1:
            self.AddDrawUIFont("Instructions", Vector2(32, 64), MYCOLOR.RED, 72)
            self.AddDrawUIFont("A/D Key : Move", Vector2(32, 130), MYCOLOR.WHITE, 30)
